...
public class Roll implements Sushi{
	...
	public Roll(String name, IngredientPortion[] roll_ingredients) {
		// Checking if the contents meet requirements
		...
		// Checking if there is enough seaweed
		boolean flag = false; 
		...
		// Creating the new array with proper contents
		...
		// Adding seaweed if there is seaweed but its quantity is not enough
		if (!flag) {
