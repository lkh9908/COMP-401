...
public class IngredientImpl implements Ingredient {
	...
	/*
	 * Constructor for IngredientImpl
	 * input: name, pricePerOz, caloriesPerOz, isVegetarian, isRice, isShellfish
	 */

	IngredientImpl(String name, double pricePerOz, int caloriesPerOz, boolean isVegetarian, boolean isRice, 
			boolean isShellfish){
		this.name = name;
